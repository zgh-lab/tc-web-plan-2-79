...
const Blog = () => {
  const featuredPost = blogPosts.find(post => post.slug === 'ai-powered-uniforms-save-lives');
  const otherPosts = blogPosts.filter(post => post.slug !== 'ai-powered-uniforms-save-lives');
