...
const Process = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      processSectionsRef.current.forEach((section, index) => {
        ...
        const distanceFromCenter = Math.abs(rect.top + (rect.height / 2) - viewportMidpoint);
  ...
  return (
    <section id="process" className="bg-white relative overflow-hidden py-[25px]">
                ...
                <div className="md:w-1/2">
                  <div 
                    className={cn(
                      ...
                      activeProcess === process.id 
                        ? "bg-wrlds-teal text-white scale-110" 
                  ...
                  <button 
                    ...
                    className={cn(
                      ...
                      activeProcess === process.id 
                        ? "text-wrlds-teal" 
                        : "text-gray-500 hover:text-wrlds-teal"
                    )}
                  >
