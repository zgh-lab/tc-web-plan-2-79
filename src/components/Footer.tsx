        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 pb-10 border-b border-gray-200">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 transition-colors hover:bg-gray-200 hover:text-gray-600">
                <Linkedin size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 transition-colors hover:bg-gray-200 hover:text-gray-600">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors">News</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors">Partners</a></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-bold mb-4 text-gray-800">Solutions</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors">Smart Sensors</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors">AI Integration</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors">Prototyping</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors">Manufacturing</a></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-bold mb-4 text-gray-800">Get in Touch</h3>
            <form className="space-y-4">
              <div>
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className="w-full px-4 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300/50"
                />
              </div>
              <button 
                type="submit" 
                className="w-full px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors flex items-center justify-center"
              >
                Subscribe
