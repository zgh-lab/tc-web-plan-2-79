        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 pb-10 border-b border-gray-200">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-500 transition-colors hover:bg-blue-500 hover:text-white">
                <Linkedin size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-500 transition-colors hover:bg-blue-500 hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-blue-500 transition-colors">News</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-500 transition-colors">Partners</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-blue-500 transition-colors">Smart Sensors</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-500 transition-colors">AI Integration</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-500 transition-colors">Prototyping</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-500 transition-colors">Manufacturing</a></li>
            </ul>
          </div>
            ...
            <form className="space-y-4">
              <div>
                <input 
                  ...
                  className="w-full px-4 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                />
              </div>
              <button 
                type="submit" 
                className="w-full px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-400 transition-colors flex items-center justify-center"
              >
                Subscribe
