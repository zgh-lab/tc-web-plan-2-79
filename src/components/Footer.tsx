      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 pb-10 border-b border-gray-200">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-wrlds-muted flex items-center justify-center text-wrlds-teal transition-colors hover:bg-wrlds-teal hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">About Us</a></li>
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">Careers</a></li>
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">News</a></li>
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">Partners</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">Smart Sensors</a></li>
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">AI Integration</a></li>
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">Prototyping</a></li>
              <li><a href="#" className="text-gray-600 hover:text-wrlds-teal transition-colors">Manufacturing</a></li>
            </ul>
          </div>
            ...
            <form className="space-y-4">
              <div>
                <input 
                  ...
                  className="w-full px-4 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-wrlds-teal/50"
                />
              </div>
              <button 
                type="submit" 
                className="w-full px-4 py-2 bg-wrlds-teal text-white rounded-md hover:bg-wrlds-teal/90 transition-colors flex items-center justify-center"
              >
                Subscribe
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-sm text-gray-500 hover:text-wrlds-teal transition-colors">Privacy Policy</a>
            <a href="#" className="text-sm text-gray-500 hover:text-wrlds-teal transition-colors">Terms of Service</a>
            <a href="#" className="text-sm text-gray-500 hover:text-wrlds-teal transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
