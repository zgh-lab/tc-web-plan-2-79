...
const Footer = () => {
  return (
    <footer id="contact" className="bg-black pt-16 pb-8 w-full text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            <img 
              ...
              className="h-10 w-auto mb-6 invert" // Using invert to make the logo white
            />
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-white transition-colors hover:bg-gray-700">
                <Linkedin size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-white transition-colors hover:bg-gray-700">
            ...
            <form className="space-y-4">
              <div>
                <input 
                  ...
                  className="w-full px-4 py-2 border border-gray-700 bg-gray-800 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-white/30"
                />
              </div>
              <button 
                type="submit" 
                className="w-full px-4 py-2 bg-white text-black rounded-md hover:bg-gray-300 transition-colors flex items-center justify-center"
              >
                Subscribe
