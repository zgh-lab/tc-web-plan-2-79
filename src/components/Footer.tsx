...
const Footer = () => {
  return (
    <footer id="contact" className="bg-blue-500 pt-16 pb-8 w-full text-white">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 pb-10 border-b border-blue-400">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white transition-colors hover:bg-white hover:text-blue-500">
                <Linkedin size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white transition-colors hover:bg-white hover:text-blue-500">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white hover:text-blue-100 transition-colors">News</a></li>
              <li><a href="#" className="text-white hover:text-blue-100 transition-colors">Partners</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-white hover:text-blue-100 transition-colors">Smart Sensors</a></li>
              <li><a href="#" className="text-white hover:text-blue-100 transition-colors">AI Integration</a></li>
              <li><a href="#" className="text-white hover:text-blue-100 transition-colors">Prototyping</a></li>
              <li><a href="#" className="text-white hover:text-blue-100 transition-colors">Manufacturing</a></li>
            </ul>
          </div>
            ...
            <form className="space-y-4">
              <div>
                <input 
                  ...
                  className="w-full px-4 py-2 border border-blue-400 bg-blue-600 text-white placeholder-blue-200 rounded-md focus:outline-none focus:ring-2 focus:ring-white/50"
                />
              </div>
              <button 
                type="submit" 
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-sm text-white hover:text-blue-100 transition-colors">Privacy Policy</a>
            <a href="#" className="text-sm text-white hover:text-blue-100 transition-colors">Terms of Service</a>
            <a href="#" className="text-sm text-white hover:text-blue-100 transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
