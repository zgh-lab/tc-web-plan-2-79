  ...
  return <div className="relative">
      ...
      <div className="banner-container bg-white relative overflow-hidden h-[450px]">
        ...
        <div className="absolute inset-0 bg-white">
          <img src="/lovable-uploads/761e2d9d-3a1c-458b-9848-dd1d7b42d1b9.png" alt="WRLDS Technologies Connected People" className="w-full h-full object-cover object-center" />
        ...
        <div className="banner-overlay bg-transparent pt-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="banner-subtitle text-gray-600 animate-fade-in animation-delay-200 max-w-2xl mx-auto mt-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6 animate-fade-in animation-delay-400">
              <a href="#projects" className="px-8 py-3 bg-blue-500 text-white rounded-md hover:bg-blue-400 transition-all shadow-lg hover:shadow-xl hover:shadow-blue-300/20 flex items-center justify-center group">
                View Our Projects
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="#process" className="px-8 py-3 bg-white border border-blue-200 text-gray-800 rounded-md hover:bg-blue-50 transition-all flex items-center justify-center">
                Our Process
              </a>
            </div>
          </div>
