        ...
        <div className="banner-overlay bg-transparent pt-28 md:pt-28 w-full">
          <div className={`w-full mx-auto ${isMobile ? 'px-4' : 'px-4 sm:px-6 lg:px-8'} flex flex-col items-start justify-center h-full`}>
            <motion.div className={`${isMobile ? 'w-full' : 'max-w-xl'} text-left`} variants={itemVariants}>
              <motion.h1 className="banner-title text-white text-3xl md:text-5xl lg:text-6xl font-bold" variants={itemVariants}>Revolutionary Textile Sensor Technology</motion.h1>
              ...
              <motion.div className="flex flex-col sm:flex-row gap-3 md:gap-4 mt-6 md:mt-8" variants={itemVariants}>
                <a href="#projects" className="px-6 md:px-8 py-2 md:py-3 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-all shadow-lg hover:shadow-xl hover:shadow-gray-300/20 flex items-center justify-center group text-sm md:text-base">
                  Explore Projects
                  <ArrowRight className="ml-2 w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" />
                </a>
                <a href="#process" className="px-6 md:px-8 py-2 md:py-3 bg-white border border-gray-200 text-gray-700 rounded-md hover:bg-gray-50 transition-all flex items-center justify-center text-sm md:text-base">
                  Our Process
                </a>
              </motion.div>
            </motion.div>
