...
const Hero = () => {
  ...
  return <div className="relative mt-16 md:mt-0 w-full"> {/* Added w-full */}
      {/* Banner with the provided image */}
      <div className="banner-container bg-white relative overflow-hidden h-[450px] md:h-[500px] w-full"> {/* Added w-full */}
        ...
        <div className="banner-overlay bg-transparent pt-28 md:pt-28 w-full"> {/* Added w-full */}
          <div className={`w-full mx-auto ${isMobile ? 'px-0 pl-0 pr-4' : 'px-4 sm:px-6 lg:px-8'} flex flex-col items-start justify-center h-full`}> {/* Removed max-w-7xl */}
            <div className={`${isMobile ? 'pr-0' : 'max-w-xl'} text-left`}> {/* Kept existing code */}
              ...
              <p className="banner-subtitle text-black animate-fade-in animation-delay-200 mt-4 md:mt-6 text-sm md:text-base"> {/* Kept existing code */}
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mt-6 md:mt-8 animate-fade-in animation-delay-400"> {/* Kept existing code */}
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8"> {/* Removed max-w-7xl mx-auto, added w-full */}
