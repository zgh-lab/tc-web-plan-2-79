    ...
    <section id="blog" className="py-16 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          <Link 
            to="/achievements" 
            className="px-6 py-3 bg-gradient-to-r from-cyan-400 via-cyan-300 to-blue-300 backdrop-blur-sm text-white rounded-lg hover:opacity-90 transition-all shadow-lg hover:shadow-xl hover:shadow-cyan-300/20 flex items-center hover:scale-105"
          >
            查看更多成果
