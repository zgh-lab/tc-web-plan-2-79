    ...
    <section id="blog" className="py-16 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-hidden">
            ...
            >
              {duplicatedShowcase.map((game, index) => (
                ...
                >
                  <div 
                    className="bg-black/20 backdrop-blur-sm rounded-xl overflow-hidden border border-white/10 group hover:shadow-xl hover:shadow-blue-400/10 transition-all h-full"
                  >
                    <div className="block h-full">
                      ...
                      <div className="p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-blue-300 text-sm group-hover:text-blue-300 transition-colors">{game.category}</span>
        ...
        <div className="flex justify-center">
          <Link 
            to="/achievements" 
            className="px-6 py-3 bg-gradient-to-r from-blue-400/80 via-blue-300/80 to-indigo-300/80 backdrop-blur-sm text-white rounded-lg hover:from-blue-400 hover:via-blue-300 hover:to-indigo-300 transition-all shadow-lg hover:shadow-xl hover:shadow-blue-400/20 flex items-center hover:scale-105"
          >
            查看更多成果
